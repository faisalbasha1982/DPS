...
export class CustomerService {
  ...
  private customerUrl = 'https://dpsapisdev.azurewebsites.net/DpsApi/Customer/CreateCustomerForm';  // URL to web api
...
//       return of([]);
//     }
//     return this.http.get<Customer[]>(`${this.heroesUrl}/?name=${term}`).pipe(
...
//   }
  ...
  addCustomer (customer: Customer): Observable<Customer> {
    return this.http.post<Customer>(this.customerUrl, customer, httpOptions).pipe(
      tap((customer: Customer) => this.log(`added hero w/ id=${customer.vatnumber}`)),
